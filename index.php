    ...
    <section id="auth_section">
        ...
        <div class="auth_container">
            ...
            <div id="Log_in">
                <h2>Увійти</h2>
                <div class="role_btn">
                    <div class="btns active">Користувач</div>
                    <div class="btns">Персонал</div>
                </div>
                ...
                <form class="user_login authsection active" id="userlogin" action="" method="POST">
                    ...
                    <button type="submit" name="user_login_submit" class="auth_btn">Увійти</button>

                    <div class="footer_line">
                        <h6>Не маєте акаунту? <span class="page_move_btn" onclick="signuppage()">Створити</span></h6>
                    </div>
                </form>
                ...
                <form class="employee_login authsection" id="employeelogin" action="" method="POST">
                    ...
                    <button type="submit" name="Emp_login_submit" class="auth_btn">Увійти</button>
                </form>
            ...
            <div id="sign_up">
                ...
                <form class="user_signup" id="usersignup" action="" method="POST">
                    ...
                    <div class="form-floating">
                        ...
                        <label for="CPassword">Підтвердити пароль</label>
                    </div>

                    <button type="submit" name="user_signup_submit" class="auth_btn">Зареєструватись</button>

                    <div class="footer_line">
                        <h6>Вже маєте акаунт? <span class="page_move_btn" onclick="loginpage()">Увійти</span></h6>
                    </div>
                </form>
            </div>
    </section>
