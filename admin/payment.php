        ...
        <table class="table table-bordered" id="table-data">
            <thead>
                <tr>
                    ...
                    <th scope="col">Кількість ліжок</th>
                    ...
                    <th scope="col">Оренда кімнати</th>
                    <th scope="col">Оренда ліжок</th>
                    <th scope="col">Харчування</th>
            ...
            ?>
                <tr>
                    ...
                    <td class="action">
                        <a href="invoiceprint.php?id= <?php echo $res['id']?>"><button class="btn btn-primary"><i class="fa-solid fa-print"></i>Друк</button></a>
						<a href="paymantdelete.php?id=<?php echo $res['id']?>"><button class="btn btn-danger">Видалити</button></a>
                    </td>
                </tr>
            <?php
            }
