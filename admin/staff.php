...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            <label for="troom">Ім'я:</label>
            <input type="text" name="staffname" class="form-control">

            <label for="bed">Посада:</label>
            <select name="staffwork" class="form-control">
                ...
                <option value="weighter">Офіціант</option>
            </select>

            <button type="submit" class="btn btn-success" name="addstaff">Додати</button>
        </form>
        ...
        while ($row = mysqli_fetch_array($re)) {
                echo "<div class='roombox'>
						<div class='text-center no-boder'>
                            ...
                            <a href='staffdelete.php?id=". $row['id'] ."'><button class='btn btn-danger'>Видалити</button></a>
						</div>
                    </div>";
        }
        ?>
