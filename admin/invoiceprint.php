...
<body>
	...
	$type_of_room = 0;
	if ($troom == "Президентська") {
		$type_of_room = 320;
	} else if ($troom == "Вишукана") {
		$type_of_room = 220;
	} else if ($troom == "Гостьова") {
		$type_of_room = 180;
	} else if ($troom == "Звичайна") {
		$type_of_room = 150;
	}
		...
		<table class="inventory">
			<thead>
				<tr>
					...
					<th><span>К-сть днів</span></th>
					<th><span>Оцінка</span></th>
					<th><span>К-сть</span></th>
			...
			<tbody>
				...
				<tr>
					<td><span><?php echo $bed; ?> Ліжка </span></td>
					<td><span><?php echo $days; ?></span></td>
	...
	<aside>
		...
		<div>
			<p align="center">Пошта: Admin@gmail.com || Сайт: www.bluebird.com || Номер телефону: +380939385612 </p>
		</div>
	</aside>
