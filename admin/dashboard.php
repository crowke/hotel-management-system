   ...
   <div class="databox">
    ...
    <div class="chartbox">
        <div class="bookroomchart">
            ...
            <h3 style="text-align: center;margin:10px 0;">Заброньовані кімнати</h3>
        </div>
        <div class="profitchart" >
            <div id="profitchart"></div>
            <h3 style="text-align: center;margin:10px 0;">Прибуток</h3>
        </div>
    </div>
</body>
